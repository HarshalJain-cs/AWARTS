...
export const mockUsers: User[] = [
  ...
  },
  {
    ...
    providers: ['gemini', 'claude'], streak: 23, totalSpend: 178900, totalTokens: 45_200_000,
  },
  {
    ...
    providers: ['claude', 'codex', 'gemini'], streak: 118, totalSpend: 892100, totalTokens: 312_000_000,
  },
  {
  ...
  },
  {
    ...
    providers: ['claude', 'gemini'], streak: 8, totalSpend: 67800, totalTokens: 19_500_000,
  },
  {
    ...
    providers: ['codex', 'gemini'], streak: 156, totalSpend: 1_234_500, totalTokens: 456_000_000,
  },
  {
...
export const mockPosts: Post[] = [
  ...
  },
  {
    ...
    providers: ['claude', 'codex', 'gemini'], providerBreakdown: [
      ...
      { provider: 'gemini', cost: 3900, inputTokens: 101000, outputTokens: 134000, sessions: 3 },
    ],
  ...
  },
  {
    ...
    providers: ['gemini'], providerBreakdown: [
      { provider: 'gemini', cost: 6700, inputTokens: 189000, outputTokens: 234000, sessions: 3 },
    ],
  ...
  },
  {
    ...
    providers: ['claude', 'gemini'], providerBreakdown: [
      ...
      { provider: 'gemini', cost: 4200, inputTokens: 112000, outputTokens: 156000, sessions: 3 },
    ],
