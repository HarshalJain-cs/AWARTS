...
export const mockUsers: User[] = [
  currentUser,
  {
    ...
    providers: ['codex', 'claude'], streak: 92, totalSpend: 5103.00, totalTokens: 156_000_000,
  },
  {
    ...
    providers: ['gemini', 'claude'], streak: 23, totalSpend: 1789.00, totalTokens: 45_200_000,
  },
  {
    ...
    providers: ['claude', 'codex', 'gemini'], streak: 118, totalSpend: 8921.00, totalTokens: 312_000_000,
  },
  {
    ...
    providers: ['claude'], streak: 14, totalSpend: 954.00, totalTokens: 28_000_000,
  },
  {
    ...
    providers: ['claude', 'gemini'], streak: 65, totalSpend: 3456.00, totalTokens: 98_000_000,
  },
  {
    ...
    providers: ['claude', 'codex'], streak: 31, totalSpend: 2013.00, totalTokens: 67_000_000,
  },
  {
    ...
    providers: ['claude', 'gemini'], streak: 8, totalSpend: 678.00, totalTokens: 19_500_000,
  },
  {
    ...
    providers: ['codex', 'gemini'], streak: 156, totalSpend: 12345.00, totalTokens: 456_000_000,
  },
  {
    ...
    providers: ['claude', 'codex'], streak: 5, totalSpend: 342.00, totalTokens: 12_000_000,
  },
];
...
export const mockPosts: Post[] = [
  {
    ...
    providers: ['codex', 'claude'], providerBreakdown: [
      { provider: 'codex', cost: 45.20, inputTokens: 89000, outputTokens: 145000, sessions: 3 },
      { provider: 'claude', cost: 21.00, inputTokens: 45000, outputTokens: 67000, sessions: 1 },
    ],
    stats: { cost: 66.20, inputTokens: 134000, outputTokens: 212000, sessions: 4 },
  ...
  },
  {
    ...
    description: 'Used all three providers to compare embeddings quality. Gemini surprised me.',
    providers: ['claude', 'codex', 'gemini'], providerBreakdown: [
      { provider: 'claude', cost: 89.00, inputTokens: 234000, outputTokens: 312000, sessions: 5 },
      { provider: 'codex', cost: 32.00, inputTokens: 67000, outputTokens: 89000, sessions: 2 },
      { provider: 'gemini', cost: 39.00, inputTokens: 101000, outputTokens: 134000, sessions: 3 },
    ],
    stats: { cost: 160.00, inputTokens: 402000, outputTokens: 535000, sessions: 10 },
  ...
  },
  {
    ...
    providers: ['claude'], providerBreakdown: [
      { provider: 'claude', cost: 54.00, inputTokens: 156000, outputTokens: 198000, sessions: 6 },
    ],
    stats: { cost: 54.00, inputTokens: 156000, outputTokens: 198000, sessions: 6 },
  ...
  },
  {
    ...
    providers: ['codex', 'gemini'], providerBreakdown: [
      { provider: 'codex', cost: 123.00, inputTokens: 345000, outputTokens: 456000, sessions: 8 },
      { provider: 'gemini', cost: 78.00, inputTokens: 198000, outputTokens: 267000, sessions: 5 },
    ],
    stats: { cost: 201.00, inputTokens: 543000, outputTokens: 723000, sessions: 13 },
  ...
  },
  {
    ...
    providers: ['claude'], providerBreakdown: [
      { provider: 'claude', cost: 32.00, inputTokens: 89000, outputTokens: 134000, sessions: 4 },
    ],
    stats: { cost: 32.00, inputTokens: 89000, outputTokens: 134000, sessions: 4 },
  ...
  },
  {
    ...
    providers: ['gemini', 'claude'], providerBreakdown: [
      { provider: 'gemini', cost: 98.00, inputTokens: 278000, outputTokens: 345000, sessions: 7 },
      { provider: 'claude', cost: 45.00, inputTokens: 123000, outputTokens: 178000, sessions: 3 },
    ],
    stats: { cost: 143.00, inputTokens: 401000, outputTokens: 523000, sessions: 10 },
    images: [], kudosCount: 72, commentCount: 15, hasKudosed: false,
    createdAt: new Date(Date.now() - 48 * 3600000).toISOString(),
  },
  {
    id: 'p7', user: mockUsers[2], title: 'Gemini first impressions: mind-blown',
    description: 'Tried Gemini for the first time on a complex data pipeline. The context window is insane.',
    providers: ['gemini'], providerBreakdown: [
      { provider: 'gemini', cost: 67.00, inputTokens: 189000, outputTokens: 234000, sessions: 3 },
    ],
    stats: { cost: 67.00, inputTokens: 189000, outputTokens: 234000, sessions: 3 },
  ...
  },
  {
    ...
    providers: ['claude'], providerBreakdown: [
      { provider: 'claude', cost: 189.00, inputTokens: 567000, outputTokens: 789000, sessions: 15 },
    ],
    stats: { cost: 189.00, inputTokens: 567000, outputTokens: 789000, sessions: 15 },
    images: [], kudosCount: 67, commentCount: 19, hasKudosed: false,
    createdAt: new Date(Date.now() - 96 * 3600000).toISOString(),
  },
  {
    id: 'p9', user: mockUsers[7], title: 'Mobile app MVP with Claude + Gemini',
    description: 'React Native app from scratch. Claude for UI, Gemini for business logic.',
    providers: ['claude', 'gemini'], providerBreakdown: [
      { provider: 'claude', cost: 76.00, inputTokens: 234000, outputTokens: 312000, sessions: 6 },
      { provider: 'gemini', cost: 42.00, inputTokens: 112000, outputTokens: 156000, sessions: 3 },
    ],
    stats: { cost: 118.00, inputTokens: 346000, outputTokens: 468000, sessions: 9 },
  ...
  },
  {
    ...
    providers: ['codex', 'claude'], providerBreakdown: [
      { provider: 'codex', cost: 56.00, inputTokens: 178000, outputTokens: 234000, sessions: 14 },
      { provider: 'claude', cost: 12.00, inputTokens: 34000, outputTokens: 45000, sessions: 2 },
    ],
    stats: { cost: 68.00, inputTokens: 212000, outputTokens: 279000, sessions: 16 },
...
export const mockComments: Comment[] = [
  ...
  { id: 'c4', user: mockUsers[5], content: 'Gemini context window is a game changer for sure.', createdAt: new Date(Date.now() - 4 * 3600000).toISOString() },
...
function generateHeatmap(): HeatmapDay[] {
  ...
  for (let i = 364; i >= 0; i--) {
    ...
    days.push({
      ...
      spend: hasActivity ? Math.floor(Math.random() * 200) + 5 : 0,
...
export const mockTestimonials = [
  { id: 't1', author: '@jamesdev', handle: 'jamesdev', content: "AWARTS made me realize I spend $400/mo on Claude. No regrets though 😂", provider: 'claude' as Provider },
  ...
  { id: 't4', author: '@devmarcus', handle: 'devmarcus', content: "Finally a way to flex my AI-powered shipping speed. AWARTS is Strava for nerds.", provider: 'claude' as Provider },
  { id: 't5', author: '@buildwithluna', handle: 'buildwithluna', content: "The multi-model tracking is a game changer. I can see exactly where each dollar goes.", provider: 'gemini' as Provider },
  { id: 't6', author: '@codekait', handle: 'codekait', content: "47 day streak and counting. AWARTS turned coding with AI into a sport 🔥", provider: 'claude' as Provider },
  { id: 't7', author: '@techpriya', handle: 'techpriya', content: "My team started using AWARTS and now we have a daily standup about our AI usage stats 😄", provider: 'codex' as Provider },
