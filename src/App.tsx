...
const Counter = lazyRetry(() => import("./pages/Counter"));
const OpenStats = lazyRetry(() => import("./pages/OpenStats"));
const TokenRich = lazyRetry(() => import("./pages/TokenRich"));
...
const WakaTimeCompare = lazyRetry(() => import("./pages/compare/WakaTime"));
const ClaudeTracker = lazyRetry(() => import("./pages/compare/ClaudeTracker"));
              ...
              <Suspense fallback={<div className="min-h-screen bg-background flex items-center justify-center"><div className="h-8 w-8 animate-spin rounded-full border-4 border-primary border-t-transparent" /></div>}>
                <PageTransition>
                  <Routes>
                    ...
                    <Route path="/token-rich" element={<TokenRich />} />
                    ...
                    <Route path="/compare/wakatime" element={<WakaTimeCompare />} />
                    <Route path="/compare/claude-code-usage-tracker" element={<ClaudeTracker />} />
