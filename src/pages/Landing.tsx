      ...
      >
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {[
            ...
            { icon: Activity, title: 'Token counter', desc: 'Track daily and weekly token usage, cache efficiency, and per-provider consumption in real time.' },
      ...
      >
        <div className="mx-auto max-w-6xl px-4 flex items-center justify-between text-sm text-muted-foreground">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/open" className="hover:text-foreground transition-colors">Open Stats</Link>
            <Link to="/token-rich" className="hover:text-foreground transition-colors">Prometheus</Link>
