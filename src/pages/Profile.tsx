        ...
        <div className="flex flex-col sm:flex-row gap-6">
          ...
          <div className="flex-1 space-y-2">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <StreakLevel totalDays={raw.stats?.total_days ?? 0} />
            </div>
