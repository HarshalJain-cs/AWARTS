...
export default function Privacy() {
  return (
    <div className="min-h-screen bg-background">
      <SEO title="Privacy Policy" description="AWARTS privacy policy — learn how we collect, use, and protect your data. No code or prompts are ever accessed." canonical="/privacy" keywords="privacy policy, data protection, AWARTS privacy, user data" jsonLd={{ "@context": "https://schema.org", "@type": "WebPage", "name": "Privacy Policy", "description": "AWARTS privacy policy", "url": "https://awarts.club/privacy" }} />
